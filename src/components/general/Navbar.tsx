      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1 ml-4">
            <Button variant="ghost" size="sm" onClick={() => router.push("/")}>Produk</Button>
            <Button variant="ghost" size="sm" onClick={() => router.push("/history")}>Riwayat</Button>
            <Button variant="ghost" size="sm" onClick={() => router.push("/checkout")}>Checkout</Button>
